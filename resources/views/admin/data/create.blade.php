...
@section('content')
<div class="container">
    <h1 class="h3 mb-4 text-gray-800">Tambah Data Penduduk</h1>
    ...
    <form action="{{ route('admin.data.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="alamat" class="form-control" 
                    value="{{ old('alamat', 'Dowangan, Banyuraden, Gamping, Sleman') }}">
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="status_keluarga" id="status_keluarga" class="form-control">
                    ...
                    <option value="Anggota Keluarga Lain" {{ old('status_keluarga') == 'Anggota Keluarga Lain' ? 'selected' : '' }}>Anggota Keluarga Lain</option>
                </select>
            </div>
            ...
            <div class="col-md-6 mb-3">
                    ...
                    <select name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-control mb-2" onchange="toggleCustomPendidikan(this.value)">
                        ...
                        <option value="Magister (S2)" {{ old('pendidikan_terakhir') == 'Magister (S2)' ? 'selected' : '' }}>Magister (S2)</option>
                        <option value="Doktor (S3)" {{ old('pendidikan_terakhir') == 'Doktor (S3)' ? 'selected' : '' }}>Doktor (S3)</option>
        ...
        <a href="{{ route('admin.data.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
@endsection
